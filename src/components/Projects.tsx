  ...
  const projects: Project[] = [
    {
      ...
      name: "Task Buddy",
      img: TaskBuddy,
      description: "A comprehensive task management application designed to help users efficiently organize, track, and manage daily to-dos with advanced features like authentication, drag-and-drop functionality, smart filters, and a clean, responsive UI.",
    ...
    },
    {
      ...
      name: "InterviewAI",
      img: InterviewAI,
      description: "An AI-powered platform that generates personalized mock interview questions from resumes. It analyzes user responses and provides intelligent feedback to help improve interview performance and confidence.",
    ...
    },
    {
      ...
      img: VideoEditor,
      description: "A powerful tool designed to simplify the process of editing, syncing, and managing video subtitles with real-time preview capabilities and intuitive controls for content creators.",
      ...
      <div className="max-w-7xl mx-auto w-full">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400 text-lg max-w-2xl mx-auto">
            Here's what I've been building lately - from <span className="text-pink-500 font-semibold">React apps</span> that actually work, 
            to <span className="text-purple-500 font-semibold">AI tools</span> that solve real problems, and 
            <span className="text-indigo-500 font-semibold"> web experiences</span> that people actually want to use.
          </p>
        </div>
        <div className="mb-8">
            ...
            return (
              <div
                ...
                className={`group relative bg-gradient-to-br from-white/20 via-pink-500/10 to-purple-500/10 dark:from-gray-800/20 dark:via-pink-500/10 dark:to-purple-500/10 backdrop-blur-lg border border-pink-500/30 dark:border-pink-500/20 rounded-3xl shadow-2xl hover:shadow-3xl transition-all duration-500 hover:scale-[1.03] hover:-translate-y-2 ${
                  isHovered ? 'ring-4 ring-pink-400/30 shadow-pink-500/30' : ''
              ...
              >
                ...
                <div className="p-3 md:p-4 flex flex-col flex-1">
                  ...
                  <div>
                    <h5 className="text-xs font-bold text-gray-800 dark:text-white mb-1.5 flex items-center gap-1">
                ...
                <div className={`absolute inset-0 rounded-2xl bg-gradient-to-r ${project.color} opacity-0 group-hover:opacity-5 transition-opacity duration-500 pointer-events-none`}></div>
              </div>
            );
          })}
        </div>
